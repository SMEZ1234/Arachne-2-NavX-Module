package redbacks.arachne.ext.navx.sensors;
 ...
 * At the moment, this sub-library is somewhat underdeveloped.
 * We use it to redirect our reading calls depending on the orientation of the NavX on our robot. Teams can do the same by extending and overriding this class.
 *
 * @author Sean Zammit
 */
public class NavX
